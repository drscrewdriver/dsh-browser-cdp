...
function FamilySettingsCard(props) {
	...
	return h("div", { style: {
		display: "grid",
		gap: "4px"
	} }, h("div", { style: rowStyle }, h("div", { style: textCol }, h("span", { style: titleStyle }, wt("famIsolate")), h("span", { style: descStyle }, wt("famIsolateDesc"))), h("input", {
		type: "checkbox",
		checked: value.isolateSpaces === true,
		disabled: !writable,
		onChange: function(e) {
			scope.set("isolateSpaces", e.target.checked);
		}
	})), h("div", { style: rowStyle }, h("div", { style: textCol }, h("span", { style: titleStyle }, wt("famIdle")), h("span", { style: descStyle }, wt("famIdleDesc"))), h("input", {
		type: "number",
		min: 0,
		max: 1440,
		value: idle,
		...
		style: { width: "72px" },
		onChange: function(e) {
			setIdle(e.target.value === "" ? 0 : Number(e.target.value));
		},
		onBlur: function(e) {
			var n = Math.max(0, Math.min(1440, Math.round(Number(e.target.value) || 0)));
			scope.set("idleTimeoutMin", n);
		}
	})));
}
function apply(ctx) {
