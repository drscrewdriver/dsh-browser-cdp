...
function buildRound(input) {
	...
	const questions = input.round === "control" ? controlQuestions(canScroll(input.frame)) : input.round === "chapter" ? chapterQuestions(chapters) : pickQuestions(offered);
